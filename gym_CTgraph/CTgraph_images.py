...
class CTgraph_images:
    ...
    def add_reward_cue(self, img, reward):
        """Add a reward cue to the image: a central square with intensity proportional to the value of the reward."""
        if self.oneD:
    ...
    def compute_random_set(self, img_nr):
        """Create the image dataset of 2D images."""
    ...
    def compute_highLevel_set(self, img_nr):
        """Create the imagee dataset of the 1D images that simulate high level input features."""
